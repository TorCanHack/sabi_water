    ...
    <div className="account-layout">
      ...
      <div className="account-main">
        ...
        <section className="account-panel" hidden={section !== 'help'} aria-labelledby="help-heading"><div className="account-panel-heading"><span className="account-section-icon"><AccountIcon name="help" /></span><div><h2 id="help-heading">A little help with your water run</h2><p>The essentials, all in one place.</p></div></div><div className="account-panel-body account-help">
          <details open><summary>How do I place an order?</summary><p>Choose your water in the shop, add a delivery address, and select your delivery time and payment method at checkout.</p><button className="text-button" onClick={() => navigate('shop')}>Explore the shop →</button></details>
          ...
          <details><summary>Where can I track my order?</summary><p>Open Orders to see your delivery progress, check payment status, or reorder a previous purchase.</p><button className="text-button" onClick={() => navigate('orders')}>View my orders →</button></details>
